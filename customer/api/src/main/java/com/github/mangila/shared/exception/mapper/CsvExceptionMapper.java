...
public class CsvExceptionMapper extends ExceptionMapperBase<CsvException>
        implements ExceptionMapper<CsvException> {
    @Override
    protected HttpProblem toProblem(CsvException e) {
